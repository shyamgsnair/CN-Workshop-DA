...
. Add this https://raw.githubusercontent.com/vrusso-pivotal/CN-Workshop-DA/master/demos/demo02/import.sql[import.sql file] found in *CN-Workshop-DA/demos/demo02/* to +src/main/resources+. This is a rather large dataset containing all of the postal codes in the United States and its territories. This file will automatically be picked up by Hibernate and imported into the in-memory database.
