...
. Copy then unpack the downloaded zip file to *CN-Workshop-DA/demos/demo01/cloud-native-spring*
+
...
*_STS Import Help:_*
+
Select File > Import… Then select Maven > Existing Maven Projects. On the Import Maven Projects page, browse to the /cloud-native-spring directory (e.g. CN-Workshop-DA/demos/demo01/cloud-native-spring)
